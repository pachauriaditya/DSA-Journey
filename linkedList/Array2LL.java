public class Array2LL {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Length of linked list: " + size(head));

        int valueToCheck = 8;
        int isPresent = check(head, valueToCheck);

        System.out.println(
            "Is " + valueToCheck + " present in the linked list? "
            + (isPresent == 1 ? "Yes" : "No")
        );
        ...
        head = insertPosition(head, 500, 2);
        print(head);
